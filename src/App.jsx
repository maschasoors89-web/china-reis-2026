...
const DAYS_TEMPLATE = [
  ...
  { id:"d03", date:"24 aug", dag:"ma", regio:"shanghai", label:"",
    ochtend:{ titel:"The Bund + Huangpu River Ferry 🛳", notitie:"Lijn 10 vanaf Jiaotong University → East Nanjing Road (~30 min). Wandel langs de skyline, pak dan de lokale pont (黄浦江渡轮) naar Pudong voor het iconische uitzicht. Paar yuan, authentiek." },
    middag:{ titel:"Baja Bikes fietstour", notitie:"bajabikes.eu – vooraf boeken." },
